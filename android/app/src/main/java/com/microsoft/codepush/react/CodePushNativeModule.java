...
public class CodePushNativeModule extends ReactContextBaseJavaModule {
    ...
    private void setJSBundle(ReactHost host, String latestJSBundleFile) throws IllegalAccessException {
        try {
...
//            setJSBundle(instanceManager, latestJSBundleFile);
            setJSBundle(host, latestJSBundleFile);
